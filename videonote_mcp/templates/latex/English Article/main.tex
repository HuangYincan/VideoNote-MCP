% 改编自 Gua927/Latex_Template 的 English Article 模板（修改版）
%   原仓库：https://github.com/Gua927/Latex_Template（English Article/ 目录）
%   修改内容：删除中国人民大学统计学院校徽（logo-RUC.png）整页背景水印；
%   其余内容与上游一致。原许可：LPPL-1.3c，见 templates/latex/ 下 NOTICE。
