...
_USER_CONFIG_MAPPED_ENV = (
    ...
    "VIDEONOTE_CACHE_TTL_DAYS",
    "VIDEONOTE_CACHE_MAX_MB",
    # 安全边界开关（#142 A1）：数据目录外路径 / 破坏性清理，默认关，插件设置显式放行
    "VIDEONOTE_ALLOW_EXTERNAL_PATHS",
    "VIDEONOTE_ALLOW_DESTRUCTIVE_CLEANUP",
)
